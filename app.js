...
const firebaseConfig = {
    apiKey: "AIzaSyBdxBNCx41pFi7-8Bb-KqD1TZ3mqxukKs4",
    authDomain: "raquelteste-c5419.firebaseapp.com",
    databaseURL: "https://raquelteste-c5419-default-rtdb.firebaseio.com/",
    projectId: "raquelteste-c5419",
    storageBucket: "gs://raquelteste-c5419.appspot.com",
    messagingSenderId: "521322836389",
    appId: "1:521322836389:web:1f52ec02b760f7f868384c"
  };
    ...
    registroPontoRef.orderByChild('data').equalTo(data).once('value', snapshot => {
        ...
        if (data) {
            Object.keys(data).forEach(key => {
                ...
                item.innerHTML = `<p>Hora: ${registroPonto.hora}, <p>Data: ${registroPonto.data}, <p>Localização: 
...
function consultarPontoPorData() {
    ...
    const registroPonto = data[key];
    const item = document.createElement('li');
    item.innerHTML = `<p>Hora: ${registroPonto.hora}, <p>Data: ${registroPonto.data}, <br>Localização: 
   ${registroPonto.localizacao}, Imagem: <p><img src="${registroPonto.imagemURL2}" alt="Imagem do ponto" 
   style="width:100px; height:auto;">`;
    lista.appendChild(item);
    });
